...
const { registeration, login ,agentRegistration,getProfileById,getAllUser,getAllArtist,editUser,deleteUser}=require("../controllers/auth-controller")
...
router.get("/getAllArtists",getAllArtist )
